...
#define ESP_UI_PHONE_1024_600_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA() \
    {                                                                      \
        .main = {                                                          \
...
#define ESP_UI_PHONE_1024_600_DRAK_GESTURE_BOTTOM_INDICATOR_BAR_DATA() \
    {                                                                  \
        .main = {                                                      \
    ...
    {                                                                               \
        ...
        .indicator_bars = {                                                         \
            [ESP_UI_GESTURE_INDICATOR_BAR_TYPE_LEFT] =                              \
                ESP_UI_PHONE_1024_600_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA(), \
            [ESP_UI_GESTURE_INDICATOR_BAR_TYPE_RIGHT] =                             \
                ESP_UI_PHONE_1024_600_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA(), \
            [ESP_UI_GESTURE_INDICATOR_BAR_TYPE_BOTTOM] =                            \
                ESP_UI_PHONE_1024_600_DRAK_GESTURE_BOTTOM_INDICATOR_BAR_DATA(),     \
        },                                                                          \
        .flags = {                                                                  \
